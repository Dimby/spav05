        ...
        <div className={classes.boxThree1}>
          <div className="content">
            ...
            <div style={{ padding: '2rem 3rem', textAlign: 'justify' }}>
              ...
              Provident cupiditate aliquid dicta expedita, animi quo quis, eum
              quam placeat facere veniam dolore quaerat nostrum? Aut asperiores
              illo repellendus eligendi voluptatibus? Lorem ipsum dolor, sit
              amet consectetur adipisicing elit. Provident cupiditate aliquid
              dicta expedita, animi quo quis, eum quam placeat facere veniam
              dolore quaerat nostrum? Aut asperiores illo repellendus eligendi
              voluptatibus? Lorem ipsum dolor, sit amet consectetur adipisicing
              elit. Provident cupiditate aliquid dicta expedita, animi quo quis,
              eum quam placeat facere veniam dolore quaerat nostrum? Aut
              asperiores illo repellendus eligendi voluptatibus?
            </div>
          </div>
        </div>
            ...
            <div className="quote">
              ...
              <div className="quoteContent">
                ...
                <div className="profil">
                  --- PS RASOLONIRINA Robert, Mpitandrina FJKM
                </div>
              </div>
            </div>
          </div>
